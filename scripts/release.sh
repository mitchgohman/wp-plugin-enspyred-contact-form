...
##############################################################################
# Release Script for Enspyred Contact Form Plugin
#
...
git add package.json enspyred-contact-form.php
...
echo -e "   1. Go to: ${BLUE}https://github.com/enspyred/wp-plugin-enspyred-contact-form/releases/new${NC}"
echo -e "   2. Select tag: ${BLUE}v${NEW_VERSION}${NC}"
echo -e "   3. Title: ${BLUE}Version ${NEW_VERSION}${NC}"
echo -e "   4. Attach file: ${BLUE}dist/enspyred-contact-form.zip${NC}"
